...
<meta charset="UTF-8">
    ...
    <title>Taste of Europe - Plan du site</title>
</head>
...
<body>
  ...
  ?>
    <ul class="plan">
        ...
        <li><a href="programme.php">Programme</li></a>
        <li><a href="tickets.php">Tickets</li></a>
        <li><a href="admin.php">Administration</li></a>
    </ul>
